...
class BenchmarkTests(unittest.TestCase):
    def test_15_variants_and_recommended_wins(self):
        variants = score_variants(solution_variants())
        self.assertEqual(len(variants), 15)
        self.assertEqual(variants[0].id, "v15")
    ...
    def test_iterative_optimizer_runs_100_iterations_for_each_variant(self):
        ...
        self.assertEqual(len(final_variants), 15)
        self.assertEqual(final_variants[0].id, "v15")
