...
def _markdown(summary: dict) -> str:
    lines = [
        "# Iterative benchmark optimization: 15 variants x 100 iterations",
        "",
        "Это воспроизводимый архитектурный benchmark-improve loop. Он не утверждает, что все 15 production pipeline полностью реализованы; он фиксирует, какие улучшения дают наибольший marginal gain по выбранным метрикам и как меняется рейтинг после 100 шагов улучшения каждого варианта.",
        "",
    ...
    lines.extend(
        [
            ...
            "Файлы:",
            "",
            "- `benchmarks/iterative_optimization.csv`: все 1500 строк benchmark before/after.",
